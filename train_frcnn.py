...
data_gen_val = data_generators.get_anchor_gt(val_imgs, class_mapping, classes_count, C2, K.image_dim_ordering(), mode='val')
...
try:
	...
	model.load_weights('C:/Fraps/resnet50_weights_tf_dim_ordering_tf_kernels_notop.h5',by_name=True)
except:
...
nb_val_samples = len(val_imgs)  # len(val_imgs),
...
model.save_weights('D:/Collage courses/GP/Ayman-frcnn/Fishy-master/notbook/models/frcnn_1_710epochs.h5')
