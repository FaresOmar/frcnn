...
weights_path = 'D:/Collage courses/GP/Ayman-frcnn/Fishy-master/notbook/models/model_frcnn.hdf5'
...
# img_path = sys.argv[1]
img_path = 'D:/Collage courses/GP/input/train/alb'
output_path = 'D:/Collage courses/GP/Ayman-frcnn/Fishy-master/notbook/output/'
bufsize = 0
...
for idx,img_name in enumerate(sorted(os.listdir(img_path))):
    ...
    if len(R) != 0:
        ...
        cv2.imwrite(output_path+img_name,img_scaled)
